...
DISTRO=NircadaOS PROJECT=Generic ARCH=x86_64 make image >&logs/x86_64.log
#>&2 echo "Generic_VK_nvidia.x86_64"
#DISTRO=NircadaOS PROJECT=Generic_VK_nvidia ARCH=x86_64 make image > logs/VK_nvidia_x86_64.log
>&2 echo "Generic.i386"
DISTRO=NircadaOS PROJECT=Generic ARCH=i386 make image >&logs/i386.log
>&2 echo "RPi.arm + noobs"
DISTRO=NircadaOS PROJECT=RPi ARCH=arm make noobs >&logs/Rpi.log
#>&2 echo "RPi.gpicase.arm + noobs"
#PROJECT=RPi BOARD=GPICase ARCH=arm make noobs
>&2 echo "RPi2.arm + noobs"
DISTRO=NircadaOS PROJECT=RPi2 ARCH=arm make noobs >&logs/Rpi2.log
>&2 echo "RPi4.arm + noobs"
DISTRO=NircadaOS PROJECT=RPi2 BOARD=RPi4 ARCH=arm make noobs >&logs/Rpi4.log
